            ...
            <div class="panel-group" id="shoufengqing">
                ...
                <div class="panel panel-default">
                    <div data-toggle="collapse" data-target="#div2" class="panel-heading">
                        <h3 class="panel-title text-center">用户信息管理</h3>
                    </div>
                    <div id="div2" class="collapse in">
                        <div class="panel-body">
                            <li><a href="#" onclick="userInfoManagement()">用户信息管理</a></li>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div data-toggle="collapse" data-target="#div3" class="panel-heading">
                        <h3 class="panel-title text-center">软件信息管理</h3>
                    </div>
                    <div id="div3" class="collapse in">
                        <div class="panel-body">
                            <li><a href="#" onclick="addRoomTypeInfo()">软件类型</a></li>
                            <li><a href="#" onclick="roomManagement()">软件信息管理</a></li>
                            <li><a href="#" onclick="addRoomInfo()">新软件发布</a></li>
                        </div>
                    </div>
                </div>
