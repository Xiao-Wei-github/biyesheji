            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">添加软件类型</h4>
                    </div>
                    <div class="modal-body">

                        <input type="text" class="form-control" id="typeId" placeholder="请输入软件类型序号">
                        <input type="text" class="form-control" id="type" placeholder="请输入软件类型">
